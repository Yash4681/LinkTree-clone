...
const NavBar = () => {
  return (
    <nav className="flex fixed top-[8vh] w-[92vw] rounded-full left-[3vw] bg-white py-3 items-center px-3 justify-between">
      ...
      <div className="flex gap-2">
        <button className="bg-gray-200 font-semibold py-4 px-7 rounded-md">Log in</button>
        <button className="bg-gray-900 text-white text-lg py-4 px-7 rounded-full">Sign up free</button>
      </div>
    </nav>
  );
};
